...
4. Keep technical terms, system names, algorithm names, model names, dataset names, variable names, and statistical terms stable; do not "translate" them into rough paraphrases.
...
- Hedging asymmetry: Chinese drafts often understate; English IEEE Transactions-style asks for precise hedging matched to evidence strength, neither over- nor under-claiming.
