...
- `manifest.yaml`: skill metadata where present.
...
By default the installer copies only:
...
This repository can track reusable architecture changes from an upstream
`nature-skills` checkout while preserving IEEE behavior.
