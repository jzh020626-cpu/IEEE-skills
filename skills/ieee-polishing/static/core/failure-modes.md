...
Terminology consistency is a cross-cutting check that runs at every level: build the Terminology Ledger on first contact (see `../../../ieee-shared/core/terminology-ledger.md`) and enforce its canonical forms throughout the polish.
