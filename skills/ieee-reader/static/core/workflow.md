...
- keep system names, algorithm names, formulas, model names, variables, and symbols intact
...
- do not silently skip Methods, limitations, reproducibility package, code availability, competing interests, or extended captions
...
If a sentence contains multiple claims, keep the translation readable but do not split away the original evidence chain. Build the Terminology Ledger (`../../../_ieee_shared/core/terminology-ledger.md`) as you translate so recurring terms stay consistent across the whole document.
