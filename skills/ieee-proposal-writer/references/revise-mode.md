...
- [Steps 5-7: Specialist-lens review, anti-slop, and revision brief](#step-5-specialist-lens-review)
...
→ specialist-lens review → anti-slop scan → revision brief → revise → rescore
```
...
### Step 5: Specialist-lens review

**Input**: structural diagnosis, claim comparison, the text itself.

**Process**: if the structural diagnosis reveals non-trivial content risks (unsupported claims in key positions, scope violations, argument gaps), dispatch one or two independent specialist lenses. See `references/specialist-lens-review.md`.

**Output**: expert reviews in `qa_logs/specialist_lens_round_XX.md`.

**Skip specialist-lens review if**:
...
**Input**: all diagnosis outputs (claim comparison, structural diagnosis, specialist-lens review, anti-slop scan).
...
qa_logs/specialist_lens_round_XX.md      — expert reviews (if specialist-lens review was used)
