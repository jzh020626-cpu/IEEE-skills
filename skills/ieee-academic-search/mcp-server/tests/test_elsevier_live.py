...
pytestmark = pytest.mark.skipif(
    os.getenv("IEEE_ACADEMIC_SEARCH_LIVE_ELSEVIER") != "1",
    reason="set IEEE_ACADEMIC_SEARCH_LIVE_ELSEVIER=1 to run live Elsevier API tests",
)
...
def test_default_search_papers_uses_free_sources_only():
    ...
    assert payload["sources_queried"] == ["crossref", "arxiv"]
