...
First record datasets or test scenarios, scale, metrics, baselines, budget, platform or network model, oracle inputs, and evaluation protocol.
...
Audit task scope, oracle or ground-truth inputs, end-to-end status, compute and communication cost, historical-data dependence, model dependence, hardest cases, deployment or domain boundary, and uncertainty. End with a bounded restatement of the main result.
