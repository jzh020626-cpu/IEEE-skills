# ieee-response test rubric

Use this rubric to manually evaluate `ieee-response` outputs against the Markdown fixtures.
...
- The response overstates unsupported causal or field-study claims.
