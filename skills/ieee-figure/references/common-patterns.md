# Common Patterns — IEEE Transactions Figure Making
...
## Pattern 14: Reliability/deployment triptych

Use for outcome-over-time figures that combine trajectories, confidence intervals, and summary proportions.
...
- Use a dashed vertical reference line in the interval/effect row.
- Group shading in the interval/effect row should be pale and subordinate.
