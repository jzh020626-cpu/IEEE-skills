...
Inspect the source for: graphical abstracts or summary models; system model and workflow diagrams; central result figures; robot/simulator/hardware snapshots; heatmaps, dimensionality reduction, networks, maps, or spatial plots; reliability curves, interval plots, calibration curves, or statistical result plots; materials characterization and performance plots; model architecture, benchmark, ablation, or error analysis figures; key tables; validation or robustness figures.
