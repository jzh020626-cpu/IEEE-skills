...
Use when the requested work requires a new robot/platform, hardware campaign, field deployment,
long-horizon validation, new simulator, new network trace, or different study design.
...
would require [new system/platform/deployment design] beyond the scope of this revision.
...
```text
This appears to be an appeal-like case rather than a revision response. `ieee-response`
