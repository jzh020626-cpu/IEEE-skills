# LaTeX layout & float typesetting for IEEE Transactions-style manuscripts
...
## 3. Do NOT rotate to landscape (IEEE Transactions house style)

IEEE Transactions / IEEE Transactions discourage rotated/landscape figures that force the
...
but try the redraw first. If the user defers ("do what IEEE Transactions does"), choose upright.
