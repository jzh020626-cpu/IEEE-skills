...
Includes unsupported claims, overinterpretation, missing control, causal claim not justified, deployment relevance not shown, or alternative explanation.
...
Includes missing repository/version identifier, figure/table data unavailable, code not provided, restricted data not justified, reproducibility metadata incomplete, or artifact availability.
...
- Coordinate with `ieee-data` if the user asks for full data-availability wording.
