...
When the user writes in Chinese, asks for "IEEE Transactions", "IEEE Transactions及其子刊", "支撑文献", "补引用", "自动给出引用", "分段引用", "导出EndNote", "RIS", "Zotero", "RDF", or provides Chinese manuscript text:
