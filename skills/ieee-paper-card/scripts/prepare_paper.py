#!/usr/bin/env python3
"""Prepare a stable source bundle for the ieee-paper-card workflow."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Prepare a normalized source bundle from an engineering-paper PDF or ieee-reader JSON."
    )
