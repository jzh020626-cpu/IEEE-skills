...
4. Reject structural reuse when those meanings differ. A 2D joint-density plot is not a reusable implementation of several 1D marginal densities, and a benchmark bar chart is not automatically a valid paired-run comparison.
...
independent unit -> runs/scenes/devices/subjects -> independent or repeated
