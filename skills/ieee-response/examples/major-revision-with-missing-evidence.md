...
Reviewer 1:
1. The manuscript requires validation in an independent platform or dataset.
...
- R1.1: Please provide the validation result summary, platform/trial count or dataset scale, and Results/Fig. 5 location.
